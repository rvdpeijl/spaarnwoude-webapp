(function() {
    ...
    /* @ngInject */
    Dashboard.$inject = ['activityService', '$rootScope', 'weatherService', 'ngProgress', '$state']; // activities come from resolve

    function Dashboard(activityService, $rootScope, weatherService, ngProgress, $state) {
